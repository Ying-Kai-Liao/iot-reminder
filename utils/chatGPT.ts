...
const JSON_PROMPT = 
    `
        ...
        The format of valid JSON is { "time": DateTime, "incident": String, "objects": String[] } 
...
const gptConverter = async (input:string) => {
    ...
    const objectizedData: Incident = sanitizedData == undefined ? sanitizedData : JSON.parse(sanitizedData);
